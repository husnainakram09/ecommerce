...
const ProductCard = () => {
    ...
    return (
        <>
            <Stack h={360} w={270} m={2} boxShadow={"0px 0px 25px 0px rgba(0, 0, 0, 0.10)"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                ...
                <Box h="100%" textAlign={"center"} bgColor={isMouseEnter ? "secondaryBlue.100" : "transparent"}>
